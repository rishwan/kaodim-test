    ...
    return (
      <React.Fragment>
        ...
        <div className={"d-block d-sm-none"}>
          <textarea className="form-control" rows="3" placeholder={"Visible on XS"} value={this.props.answer} autoComplete="off" name={this.props.question.id} onChange={this.onChange}/>
        </div>
        <div className={"d-none d-sm-block d-md-none"}>
          <textarea className="form-control" rows="3" placeholder={"Visible on SM"} value={this.props.answer} autoComplete="off" name={this.props.question.id} onChange={this.onChange}/>
        </div>
        <div className={"d-none d-md-block d-lg-none"}>
          <textarea className="form-control" rows="5" placeholder={"Visible on MD"} value={this.props.answer} autoComplete="off" name={this.props.question.id} onChange={this.onChange}/>
        </div>
        <div className={"d-none d-lg-block d-xl-none"}>
          <textarea className="form-control" rows="5" placeholder={"Visible on LG"} value={this.props.answer} autoComplete="off" name={this.props.question.id} onChange={this.onChange}/>
        </div>
        <div className={"d-none d-xl-block"}>
          <textarea className="form-control" rows="5" placeholder={"Visible on XL"} value={this.props.answer} autoComplete="off" name={this.props.question.id} onChange={this.onChange}/>
        </div>
      </React.Fragment>
    )
  }
